                ...
                <div class="row">
                    <div class="col-sm">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" placeholder="單位名稱" required autocomplete="off">
                        </div>
                    </div>
                    <div class="col-sm">
                        <div class="form-group">
                            <label for="identify">帳號隸屬負責人</label>
                            <input type="text" class="form-control" id="identify" placeholder="帳號隸屬負責人" required disabled autocomplete="off">
                        </div>
                    </div>
                </div>
                <div class="row">
